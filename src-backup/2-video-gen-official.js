...
(async () => {
    ...
    for (let i = 1; i <= LOOP_COUNT; i++) {
        ...
        try {
            ...
            // ==========================================
            // BƯỚC 6: HOVER TẢI XUỐNG VÀ CLICK 1080P
            // ==========================================
            ...
            console.log(`👉 7. Đang bấm tải 1080p và xử lý file...`);
            const resolution2K = page.getByText('1080', { exact: true }).last();
